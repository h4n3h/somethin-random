...
class MagicHomeApi:
    ...
    def send_preset_function(self, preset_number, speed):
        ...
        if type == 4:
            ...
            self.send_bytes(*(message+[self.calculate_checksum(message)]))
            #print('teste')
            #print(send_bytes(*(message+[self.calculate_checksum(message)])))
    ...
    def send_bytes(self, *bytes):
        ...
        try:
            ...
            print(struct.pack("B" * message_length, *bytes))
...
controller1 = MagicHomeApi('192.168.0.13', 3)
#controller2 = MagicHomeApi('192.168.0.15', 3)
